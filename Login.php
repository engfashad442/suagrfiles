...
if ( sugar_is_file('custom/include/images/sugar_md.png') ) {
	//commented out by shuaib
   // $login_image = '<IMG src="custom/include/images/sugar_md.png" alt="Sugar" width="340" height="25">';
}
else {
	//commented out by shuaib : This removes the sugar note from the form
...
// RECAPTCHA
 ...
 //This line was commented by shuiab. and it removed the login form from the loggin page
