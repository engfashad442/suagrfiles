...
//Replacing  'index.php?module=Employees&action=index&query=true' with https://fioriapps.cwlgroup.com/sap/bc/nwbc     
$global_control_links['employees'] = array(
'linkinfo' => array($app_strings['LBL_EMPLOYEES']=> 'https://fioriapps.cwlgroup.com/sap/bc/nwbc'),
'submenu' => ''
);
if (
...
//Replacing 'javascript:void(window.open(\'http://support.sugarcrm.com\')) with http://olamanagement.cwlgroup.com:8080/      
$global_control_links['training'] = array(
'linkinfo' => array($app_strings['LBL_TRAINING'] => 'http://olamanagement.cwlgroup.com:8080/'),
'submenu' => ''
 );
...
//Replacing  index.php?'index.php?module=Home&action=About' with 'http://cwg-plc.com/'
$global_control_links['about'] = array('linkinfo' => array($app_strings['LNK_ABOUT'] => 'http://cwg-plc.com/'),
'submenu' => ''
);
