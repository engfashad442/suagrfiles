...
<div style ="color:#4682B4 ;background:#ffffff; padding:10px; border-radius:8px;font-size:20px; font-style:italic"> <marquee>Welcome to CWG sugarCRM Platform  </marquee></div>
	...
	<tr>
		...
		<div class="loginBoxShadow" style="width: 460px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
				<tr>
				<!--This line is being commented out by shuaib-->
...
<!--Adding additional break tags : The default tags are 2-->
<br>
<br>
<br>
<br>